<?php
  ...
  $query = "SELECT * FROM orders WHERE id_number = '$id_number'";
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    $insert = "INSERT INTO orders (firstName, lastName, id_number, phone_num, location) 
    VALUES ('$firstName', '$lastName', '$id_number', '$phone_number', '$location')";
